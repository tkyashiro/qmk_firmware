...
// #define MASTER_LEFT
#define MASTER_RIGHT    // since ps2 mouse will be on right hand side
// #define EE_HANDS
...
/* for PS2 interuption */
#ifdef PS2_USE_INT
# define PS2_CLOCK_PORT  PORTB  // clock pin 
# define PS2_CLOCK_PIN   PINB   //
# define PS2_CLOCK_DDR   DDRB   //
# define PS2_CLOCK_BIT   5      //
# define PS2_DATA_PORT   PORTB  // data pin
...
# define PS2_INT_VECT   PCINT0_vect // interuption vector
#endif
